<template>
  <div class="categories">
    ...
    <el-card class="table-category">
      <el-table :data="students" stripe style="width: 100%" height="calc(100vh - 340px)">
        <el-table-column width="300px" prop="name" label="Tên sinh viên">
        </el-table-column>
        <el-table-column prop="code" label="Mã sinh viên"> </el-table-column>
        <el-table-column prop="gender" label="Giới tính"> </el-table-column>
        <el-table-column prop="birth" label="Ngày sinh"> </el-table-column>
        <el-table-column prop="school" label="Trường"> </el-table-column>
        <el-table-column prop="k" label="Khóa"> </el-table-column>
      </el-table>
